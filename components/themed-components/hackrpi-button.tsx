...
export default function HackRPIButton(props: HackRPIButtonProps) {
	return (
		<button
			...
			} flex group  border-2  hover:bg-hackrpi-pink hover:text-hackrpi-orange transition-colors duration-200 font-neutral font-medium ring-hackrpi-pink relative pr-4`}
		>
